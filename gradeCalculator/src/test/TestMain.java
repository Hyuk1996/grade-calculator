...
public class TestMain {
    School fancySchool = School.getInstance();
    Subject korean;
    Subject math;
    Subject dance;
    ...
    public void createSubject() {
        ...
        fancySchool.addSubject(korean);
        fancySchool.addSubject(math);
        fancySchool.addSubject(dance);
    }
    ...
    public void createStudent() {
        ...
        Student student5 = new Student(121590, "최태평", math);

        fancySchool.addStudent(student1);
        fancySchool.addStudent(student2);
        fancySchool.addStudent(student3);
        fancySchool.addStudent(student4);
        fancySchool.addStudent(student5);
